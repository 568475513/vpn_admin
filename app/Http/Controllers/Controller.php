...
class Controller extends BaseController
{
    ...
    public function addReferralLog($userId, $refUserId, $oid, $amount, $refAmount)
    {
         ...
         *  余额返利
         */
        $user = User::query()->where('id', $refUserId)->first();
        // 写入余额变动日志
        $this->addUserBalanceLog($refUserId, 0, $user->balance, $user->balance + $refAmount, $refAmount, '推广返利');
        $user->increment('balance',$refAmount*100);
