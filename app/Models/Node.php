...
class Node extends Model
{
    ...
    public function ruleGroupNode(): HasOne
    {
    ...
    public function nodeLabel(): BelongsToMany
    {
        return $this->belongsToMany(NodeLabel::class);
    }
    ...
    public function users()
    {
        return User::activeUser()
            ...
            ->where(function ($query) {
                $query->whereIn('id', $this->nodeLabel->users->pluck('id'));
            })
            ->get();
    }
