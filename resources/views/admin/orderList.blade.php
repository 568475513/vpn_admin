                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <select class="form-control" name="goods_id" id="goods_id" onchange="doSearch()">
                                    <option value="" @if(Request::get('goods_id') == '') selected @endif>套餐搜索</option>
                                     @foreach($goodsList as $goods)
                                	 <option value="{{$goods->id}}" @if(Request::get('goods_id') == $goods->id) selected @endif>{{$goods->name}}</option>
                                    @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($order->pay_way == '6')
                                                        <span class="label label-info"> Stripe支付 </span>
                                                    @else
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <div class="dataTables_info" role="status" aria-live="polite">共支付 {{$total_price/100}} 元</div>
                            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            window.location.href = '{{url('admin/orderList')}}' + '?username=' + username + '&is_expire=' + is_expire + '&is_coupon=' + is_coupon + '&pay_way=' + pay_way + '&status=' + status + '&sort=' + sort+ '&goods_id=' + goods_id + '&range_time=' + range_time;
        }
