                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <input type="text" class="form-control" name="create_at" id="range_time" placeholder="创建时间" autocomplete="off" />
                            </div>
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    @else
                                        @foreach ($userList as $user)
                                            <tr class="odd gradeX {{$user->trafficWarning ? 'danger' : ''}}">
                                                ...
                                                <td class="center"> {{$user->balance}} 元</td>
                                                <td class="center">
    ...
    <script type="text/javascript">
     // 有效期
        ...
        function doSearch() {
            ...
            window.location.href = '{{url('admin/userList')}}' + '?id=' + id +'&username=' + username + '&wechat=' + wechat + '&qq=' + qq + '&port=' + port + '&pay_way=' + pay_way + '&status=' + status + '&enable=' + enable + '&range_time=' + range_time;
        }
