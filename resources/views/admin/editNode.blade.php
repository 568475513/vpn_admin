                                        ...
                                        <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="ssr-setting {{$node->type == 1 ? '' : 'hidden'}}">
                                                    ...
                                                    <div class="form-group single-setting {{!$node->single ? 'hidden' : ''}}">
                                                        <label for="port" class="col-md-3 control-label">[单] 服务端口</label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="port" value="{{$node->port}}" id="port" placeholder="999">
                                                            <span class="help-block">服务端需要配置 </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group single-setting {{!$node->single ? 'hidden' : ''}}">
                                                        <label for="speed_limit" class="col-md-3 control-label">[单] 限速</label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="speed_limit" value="{{$node->speed_limit}}" id="speed_limit" placeholder="1">
                                                            <span class="help-block">M </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group single-setting {{!$node->single ? 'hidden' : ''}}">
                                                        <label for="client_limit" class="col-md-3 control-label">[单] 限制连接</label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="client_limit" value="{{$node->client_limit}}" id="client_limit" placeholder="1">
                                                            <span class="help-block">限制连接 </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- V2ray 设置部分 -->
