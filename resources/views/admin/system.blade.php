                                ...
                                <div class="portlet-title tabbable-line">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            <a href="#tab_11" data-toggle="tab"> Stripe支付 </a>
                                        </li>
                                        <li>
                                            <a href="#tab_12" data-toggle="tab"> 微信支付 </a>
                                        </li>
                                            ...
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <label for="referral_days" class="col-md-3 control-label">注册送天数</label>
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input class="form-control" type="text" name="referral_gift_days" value="{{$referral_days}}" id="referral_days" />
                                                                    <span class="input-group-addon">天</span>
                                                                    <span class="input-group-btn">
                                                                    <button class="btn btn-success" type="button" onclick="setReferralDays()">修改</button>
                                                                </span>
                                                                </div>
                                                                <span class="help-block"> 根据推广链接、邀请码注册则赠送相应的天数 </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane" id="tab_11">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="portlet-body">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <label for="is_f2fpay"
                                                                   class="col-md-3 control-label">本功能</label>
                                                            <div class="col-md-9">
                                                                <input type="checkbox" class="make-switch" @if($is_stripepay) checked @endif id="is_stripepay" data-on-color="success" data-off-color="danger" data-on-text="启用" data-off-text="关闭">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                    	<div class="col-md-6 col-sm-6 col-xs-12">
                                                            <label for="alipay_partner" class="col-md-3 control-label">PUBLISH KEY</label>
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input class="form-control" type="text" name="stripepay_publish_key" value="{{$stripepay_publish_key}}" id="stripepay_publish_key"/>
                                                                    <span class="input-group-btn">
                                                                        <button class="btn btn-success" type="button" onclick="setStripepayPublishKey()">修改</button>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <label for="alipay_private_key"
                                                                   class="col-md-3 control-label">API KEY</label>
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input class="form-control" type="text" name="stripepay_api_key" value="{{$stripepay_api_key}}" id="stripepay_api_key"/>
                                                                    <span class="input-group-btn">
                                                                        <button class="btn btn-success" type="button" onclick="setStripepayApiKey()">修改</button>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab_12">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="portlet-body">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <label for="is_wechatpay"
                                                                   class="col-md-3 control-label">本功能</label>
                                                            <div class="col-md-9">
                                                                <input type="checkbox" class="make-switch" @if($is_wechatpay) checked @endif id="is_wechatpay" data-on-color="success" data-off-color="danger" data-on-text="启用" data-off-text="关闭">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        // 设置根据推广链接注册送天数
        function setReferralDays() {
            var referral_days = parseInt($("#referral_days").val());
        ...
        function setStripepayPublishKey() {
            var stripepay_publish_key = $("#stripepay_publish_key").val();

            $.post("{{url('admin/setConfig')}}", {
                _token: '{{csrf_token()}}',
                name: 'stripepay_publish_key',
                value: stripepay_publish_key
            }, function (ret) {
                layer.msg(ret.message, {time: 1000}, function () {
                    if (ret.status == 'fail') {
                        window.location.reload();
        ...
        function setStripepayApiKey() {
            var stripepay_api_key = $("#stripepay_api_key").val();

            $.post("{{url('admin/setConfig')}}", {
                _token: '{{csrf_token()}}',
                name: 'stripepay_api_key',
                value: stripepay_api_key
            }, function (ret) {
                layer.msg(ret.message, {time: 1000}, function () {
                    if (ret.status == 'fail') {
                        window.location.reload();
