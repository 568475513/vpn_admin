                    ...
                    <div class="portlet-body">
                         <div class="row" style="padding-bottom:5px;">
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <input type="text" class="col-md-4 form-control" name="sn" value="{{Request::get('sn')}}" id="sn" placeholder="卷码" onkeydown="if(event.keyCode==13){do_search();}">
                            </div>
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <select class="form-control" name="status" id="status" onChange="do_search()">
                                    ...
                                    <option value="1" @if(Request::get('status') == '1') selected @endif>已使用</option>
                                    <option value="2" @if(Request::get('status') == '2') selected @endif>已失效</option>
                                    <option value="0" @if(Request::get('status') == '0') selected @endif>未使用</option>
                                </select>
                            </div>
                            <div class="col-md-3 col-sm-4 col-xs-12">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function do_search() {
            ...
            window.location.href = '{{url('coupon/couponList')}}' + '?sn=' + sn  + '&status=' + status;
        }

        // 重置
        function do_reset() {
            window.location.href = '{{url('coupon/couponList')}}';
        }
    </script>
@endsection
