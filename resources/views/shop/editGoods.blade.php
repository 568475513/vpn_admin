                        ...
                        <form action="{{url('shop/editGoods')}}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="traffic" value="{{$goods->traffic}}" id="traffic" placeholder="">
                                ...
                                <div class="form-group package-money">
                                    <label class="control-label col-md-3">IOS产品ID</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="iosid" value="{{$goods->iosid}}" id="iosid" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="days" value="{{$goods->days}}" id="days" placeholder="">
                                ...
                                @endif
                                <div class="form-group">
                                    <label for="is_vip" class="col-md-3 control-label">高级套餐</label>
                                    <div class="col-md-6">
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input type="radio" name="is_vip" value="1" @if($goods->is_vip == 1) checked @endif> 是
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                                <input type="radio" name="is_vip" value="0" @if($goods->is_vip == 0) checked @endif> 否
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
