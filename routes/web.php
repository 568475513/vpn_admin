...
Route::group(['middleware' => ['isForbidden', 'isLogin', 'isAdmin']], function () {
     ...
     *  游戏管理
     */
    Route::get('admin/gameList', 'AdminController@gameList'); // 列表游戏
    Route::any('admin/addGame', 'AdminController@addGame'); // 添加游戏
    Route::any('admin/editGame', 'AdminController@editGame'); // 编辑游戏
    Route::post('admin/delGame', 'AdminController@delGame'); // 删除游戏
